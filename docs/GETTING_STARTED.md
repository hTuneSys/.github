...
# 🚀 Getting Started with hTuneSys

Welcome to the hTuneSys project! This guide will help you set up your development environment, build the project components, and get started with contributing or using hTuneSys.
...
1. **Clone the repository**:
   ```bash
   git clone https://github.com/hTuneSys/hTuneSys.git
   cd hTuneSys
   ```
...
3. **Connect your hTuneSys device** via USB and put it in BOOTSEL mode (hold BOOTSEL button while plugging in).
...
1. **Open KiCad** and load the project:
   - Navigate to `hardware/hTuneSys-v1/`
   - Open `hTuneSys-v1.kicad_pro`

2. **View schematics**:
   - Open `hTuneSys-v1.kicad_sch`

3. **View PCB layout**:
   - Open `hTuneSys-v1.kicad_pcb`
...
You're now ready to explore and build with hTuneSys. Happy hacking!
